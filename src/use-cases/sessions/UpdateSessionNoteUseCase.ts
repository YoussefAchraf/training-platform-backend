...
class UpdateSessionNoteUseCase {
  ...
  async execute({ requester, sessionId, noteId, body }: { requester: any; sessionId: any; noteId: any; body: any }) {
    ...
    return this.sessionNoteRepository.update(noteId, trimmed);
  }
}

export { UpdateSessionNoteUseCase };
